...
N_a = np.array([train_x.shape[0], 64, 32, 16, 1])  # compact notation for nodes in each layer. The first number corresponds to the input layer
...
# N_a = np.array([train_x.shape[0], 8, 4, 1])  # compact notation for nodes in each layer. The first number corresponds to the input layer
