...
# July 13, 2025: Huge impact on the results depending on how we flatten!!

# Flatten 1: 34% on test database
# train_x = train_x_org.reshape(Nx*Ny*Nc, N_train)/255
# test_x = test_x_org.reshape(Nx*Ny*Nc, N_test)/255

# # Flatten 2: 70% on test database (July 13, 2025)
# train_x = train_x_org.T.reshape(Nx*Ny*Nc, N_train)/255
# test_x = test_x_org.T.reshape(Nx*Ny*Nc, N_test)/255
